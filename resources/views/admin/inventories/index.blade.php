...
<div class="header-actions" style="margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
    <div>
        <h2 style="font-size: 1.8rem; font-weight: 800; margin-bottom: 0.5rem;">Manajemen Stok Barang</h2>
        <p style="opacity: 0.6;">Kelola persediaan bahan baku dan perlengkapan outlet.</p>
    </div>
