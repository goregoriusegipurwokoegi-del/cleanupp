...
<div class="header-actions" style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
    <div>
        <h2 style="font-size: 1.8rem; font-weight: 800; margin-bottom: 0.5rem;">Manajemen Karyawan</h2>
        <p style="opacity: 0.6;">Daftarkan staf, tentukan jam kerja, dan pantau kehadiran mereka.</p>
    </div>
